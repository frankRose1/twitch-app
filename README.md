# Twitch App
Recently refactored to use react. Pulls 12 of the top current streams and displays them the DOM. Clicking on a grid item will pull up a modal with more information about that stream and will include a link to the stream on twitch.
